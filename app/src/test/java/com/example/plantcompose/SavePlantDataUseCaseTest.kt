...
class SavePlantDataUseCaseTest {

    private lateinit var plantComposeRepository: PlantComposeRepository
    private lateinit var useCase: SavePlantsUseCase
    ...
    fun setup() {
        ...
        useCase = SavePlantsUseCase(plantComposeRepository = plantComposeRepository)
    }
    ...
    @Test
    fun testSavePlatDataSuccess() = runTest {
        // Given
        every {
            plantComposeRepository.savePlant(
                plants = listOf(MOCK_PLANT),
            )
        } returns flowOf(
            Result.success(
                Unit
    ...
    @Test
    fun testSavePlatDataFailed() = runTest {
        // Given
        every {
            plantComposeRepository.savePlant(
                plants = listOf(MOCK_PLANT),
